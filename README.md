...
```typescript
const prathmesh: Developer = {
  name        : "Prathmesh Kharwade",
  location    : "Maharashtra, India 🇮🇳",
  role        : "Full Stack Developer",

  frontend    : ["React", "Next.js", "TypeScript", "GSAP", "WebGL", "Three.js"],
  backend     : ["Node.js", "Express.js", "REST APIs", "GraphQL"],
  database    : ["MongoDB", "MySQL", "Redis", "PostgreSQL", "VectorDB"],
  devOps      : ["Docker", "Git", "GitHub Actions", "Vercel", "Nginx"],

  currentFocus: "Building immersive, high-performance web experiences",
  learning    : ["Web3", "AI/ML integrations", "3D Web Animations"],
  available   : true,
...
<img src="https://img.shields.io/badge/VectorDB-4B0082?style=for-the-badge&logo=databricks&logoColor=white"/>
<img src="https://img.shields.io/badge/Pinecone-000000?style=for-the-badge&logo=pinecone&logoColor=white"/>

**🐳 DevOps & Tools**

<img src="https://skillicons.dev/icons?i=docker,git,github,vscode,postman,vercel,linux&theme=dark" />

</div>

---

## `📊 github_stats --creative`
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/prathmeshkharwade-dev/prathmeshkharwade-dev/output/github-contribution-grid-snake-dark.svg"/>
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/prathmeshkharwade-dev/prathmeshkharwade-dev/output/github-contribution-grid-snake.svg"/>
  <img alt="Snake animation" src="https://raw.githubusercontent.com/prathmeshkharwade-dev/prathmeshkharwade-dev/output/github-contribution-grid-snake-dark.svg"/>
</picture>
...
<!-- FOOTER WAVE -->
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=24,20,12&height=120&section=footer&animation=twinkling"/>
